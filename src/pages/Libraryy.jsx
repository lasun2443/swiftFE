...
export default function Lib() {
    ...
    const fetchPlaylists = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://musicappbe.onrender.com/api/playlists/${user.id}`,
          {
            headers:{
  ...
  return (
    <div className="p-6 bg-zinc-950 text-white h-screen">
      {isLoading ? (
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            {playlists.length > 0 ? ( // Check if length is greater than 0
              ...
              <div className="h-[90vh] col-span-12 flex flex-col items-center justify-center ">
